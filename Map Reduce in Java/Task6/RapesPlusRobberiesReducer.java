// =============================================================================
// Program name: RapesPlusRobberiesReducer.java
// Author:       Animish Andraskar
// =============================================================================
// DESCRIPTION:
// ------------
// This program reduces the set of intermediate values which share a key
// ("Rapes and robberies") to a smaller set of values (count of crimes)
...
public class RapesPlusRobberiesReducer extends MapReduceBase implements Reducer<Text, IntWritable, Text, IntWritable> {
